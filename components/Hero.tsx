        ...
        <div className="grid items-stretch gap-14 md:grid-cols-2 md:gap-16">
          ...
          <div className="flex justify-center md:self-stretch">
            <GlitchPerspectiveImage
              ...
              className="relative h-[360px] w-[300px] overflow-hidden rounded-3xl border border-border/60 bg-surface-2/45 shadow-[0_24px_60px_-36px_rgba(125,87,69,0.45)] sm:h-[420px] sm:w-[340px] md:h-full md:w-[360px] lg:max-h-[560px]"
            />
          </div>
        </div>
      </div>
